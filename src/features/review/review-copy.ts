...
const reviewCopy: Record<ReviewUiLanguage, ReviewCopy> = {
  ...
  vi: {
    pageEyebrow: "Xem lại hand",
    pageTitle: "Ghi 1 tình huống, 1 leak, 1 bước học tiếp",
    pageBody: "Giữ ghi chú ngắn, sắc và đúng hand. Chụp tình huống, chốt line, đánh dấu chỗ còn vướng.",
    savedReviews: "Ghi chú đã lưu",
    lastUpdated: "Cập nhật cuối",
    leakPeak: "Leak lặp nhiều",
    localMode: "Máy này",
    accountMode: "Đồng bộ đám mây",
    saving: "Đang lưu",
    savedState: "Đã lưu",
    issueState: "Có lỗi",
    saveSuccessAccount: "Đã lưu ghi chú hand vào tài khoản đang đăng nhập.",
    saveSuccessLocal: "Đã lưu ghi chú hand trên trình duyệt này.",
    saveFailure: "Không lưu được ghi chú hand.",
    deleteSuccessAccount: "Đã xóa ghi chú hand khỏi tài khoản đang đăng nhập.",
    deleteSuccessLocal: "Đã xóa ghi chú hand khỏi bộ nhớ trình duyệt này.",
    deleteFailure: "Không xóa được ghi chú hand.",
    deleteConfirm: "Xóa ghi chú hand đã lưu này?",
    listEyebrow: "Danh sách đã lưu",
    listTitle: "Mở ghi chú đã lưu",
    listBodyAccount: "Các ghi chú này đang đồng bộ theo tài khoản đang đăng nhập.",
    listBodyLocal: "Các ghi chú này đang ở lại trên trình duyệt này.",
    noSavedTitle: "Chưa có ghi chú đã lưu",
    noSavedBody: "Lưu một ghi chú từ bàn xem lại hand và nó sẽ hiện ở đây.",
    loadingTitle: "Đang tải ghi chú",
    loadingBody: "Đang đọc danh sách ghi chú từ chế độ lưu hiện tại.",
    loadIssue: "Lỗi tải dữ liệu",
    retry: "Tải lại",
    detailEyebrow: "Chi tiết hand",
    detailTitle: "Chọn một hand đã lưu",
    detailBody: "Hand đã lưu sẽ mở ở đây cùng line đã chọn, leak chính và bước học tiếp.",
    deleteLabel: "Xóa ghi chú",
    deletingLabel: "Đang xóa ghi chú...",
    noLeakTags: "Chưa có nhãn leak",
    noLeakTagsAssigned: "Chưa gắn nhãn leak",
    followUpLabel: "Học tiếp",
    openModuleLabel: "Mở bài luyện",
    formEyebrow: "Ghi chú hand",
    formTitle: "Chốt 1 ghi chú hand",
    formBody: "Ghi nhanh tình huống, line đã chọn và câu hỏi còn vướng. Đây là bàn xem lại hand, không phải biểu mẫu quản trị.",
    snapshotLabel: "Ảnh tình huống",
    decisionNoteLabel: "Ghi chú quyết định",
    leakTagsLabel: "Nhãn leak",
    titleLabel: "Tiêu đề",
    titleHint: "Nhãn ngắn cho tình huống bạn muốn nhớ lại.",
    titlePlaceholder: "BTN vs BB top pair river fold",
    ...
    actionHistoryHint: "Viết ngắn để lần sau dựng lại tình huống ngay.",
    ...
    uncertaintyPlaceholder: "Đây là fold kỷ luật hay đang bỏ quá nhiều?",
    noteLabel: "Ghi chú thêm",
    noteHint: "Read, điểm học hoặc yếu tố tâm lý.",
    notePlaceholder: "Kết quả hand trước có thể đã ảnh hưởng tới quyết định này.",
    storageAccount: "Ghi chú đã lưu sẽ đồng bộ vào tài khoản đang đăng nhập.",
    storageLocal: "Ghi chú đã lưu sẽ ở lại trên trình duyệt này.",
    saveLabel: "Chốt ghi chú",
    savingLabel: "Đang lưu ghi chú...",
    streetFocusLabels: {
      general: "Tổng quát",
      preflop: "Preflop",
      flop: "Flop",
