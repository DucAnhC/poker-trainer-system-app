...
const reviewCopy: Record<ReviewUiLanguage, ReviewCopy> = {
  ...
  vi: {
    ...
    pageBody: "Giữ review ngắn, sắc và đúng hand. Chụp tình huống, chốt line, đánh dấu chỗ còn vướng.",
    ...
    deleteSuccessLocal: "Đã xóa ghi chú hand khỏi local storage.",
    ...
    formBody: "Ghi nhanh tình huống, line đã chọn và câu hỏi còn vướng. Đây là bàn xem lại hand, không phải form quản trị.",
    ...
    noteHint: "Read, điểm học hoặc yếu tố mental game.",
    ...
    storageLocal: "Ghi chú đã lưu sẽ ở lại trên trình duyệt này qua localStorage.",
